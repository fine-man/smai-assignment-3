...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run Wandb Experiments for Task 5.1 of SMAI Assignment 3")
    
    parser.add_argument(
        '-p', '--path', default=f'{YAML_FOLDER}/task-5.1/multi-mnist-two-conv-layers.yaml',
    ...
    print(DOUBLE_MNIST_FOLDER)

    print(f"Path of sweep configuration file: {path}", flush=True)

    train_dataset, val_dataset, test_dataset = load_and_process_double_mnist(DOUBLE_MNIST_FOLDER)
