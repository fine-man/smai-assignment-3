...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run Wandb Experiments for Task 2.2 of SMAI Assignment 3")
    
    parser.add_argument(
        '-p', '--path', default=f'{YAML_FOLDER}/task-2.2/single-layer-sgd-grid-search.yaml',
